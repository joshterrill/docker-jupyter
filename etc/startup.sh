...
trap 'su -l -c "jupyter notebook stop -y" josh; exit 0;' SIGTERM 	trap 'su -l -c "jupyter notebook stop -y" root; exit 0;' SIGTERM 
/usr/sbin/nginx	/usr/sbin/nginx
su -l -c 'jupyter notebook' josh &	su -l -c 'jupyter notebook' root &
wait